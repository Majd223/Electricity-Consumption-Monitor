...
namespace Fridge
{
    class Program
    {
        ...
        // Telemetry globals.
        const int intervalInMilliseconds = 300000;        // Time interval required by wait function.

        // Refrigerated truck globals.
        static string identification = "Fridge1";
        static double lat = 47.642441;              // Base position latitude.
        static double lon = -122.137032;            // Base position longitude.
       // const string noEvent = "none";
        ...
        static int[] consumptionOverTime = new int[] {400, 350, 200, 150, 150, 150 };

        //Temperature over time depending on its consumption
        static int[] applianceTemperatureOverTime = new int[] {300, 293, 295, 290, 288, 285};
        ...
        static double[] returnMinMax(double[] voltageTimeLapse)
        {
            ...
            for(int i = 0; i < voltageTimeLapse.Length; i++)
            {
